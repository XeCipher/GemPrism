...
export const ALL_MODELS: Record<string, { name: string; rpm: number; rpd: number }> = {
  ...
  "imagen-4-generate": { name: "Imagen 4 Generate", rpm: 15, rpd: 25 },
  "imagen-4-ultra-generate": { name: "Imagen 4 Ultra Generate", rpm: 15, rpd: 25 },
  "imagen-4-fast-generate": { name: "Imagen 4 Fast Generate", rpm: 15, rpd: 25 },
  ...
  "gemma-3-1b": { name: "Gemma 3 1B", rpm: 30, rpd: 14400 },
  "gemma-3-2b": { name: "Gemma 3 2B", rpm: 30, rpd: 14400 },
  "gemma-3-4b": { name: "Gemma 3 4B", rpm: 30, rpd: 14400 },
  "gemma-3-12b": { name: "Gemma 3 12B", rpm: 30, rpd: 14400 },
  "gemma-3-27b": { name: "Gemma 3 27B", rpm: 30, rpd: 14400 },
